...
const Companies = () => {
  return (
    <div className='pt-6'>
       <p className='text-gray-500  ' >Trusted by <span className='font-semibold italic underline text-blue-500'>Learners</span> and other <span className='font-semibold text-blue-500 italic underline'>Companies</span> </p>
